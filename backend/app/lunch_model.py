...
model_path = os.path.join(os.path.dirname(__file__), 'lunch_model.pkl')

# Load the model
with open(model_path, 'rb') as model_file:
    model = pickle.load(model_file)

def predict_lunch(user_data):
    """
    Predicts lunch based on the user's data.

    :param user_data: Dictionary containing the user's information.
    :return: Predicted lunch.
    """
    ...
    model_features = [
        ...
        'Assigned_Lunch_Calories', 'Waist', 'Diabetes', 'Hypertension',
