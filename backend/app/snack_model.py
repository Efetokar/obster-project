...
model_path = os.path.join(os.path.dirname(__file__), 'snack_model.pkl')

# Load the model
with open(model_path, 'rb') as model_file:
    model = pickle.load(model_file)

def predict_snack(user_data):
    """
    Predicts a snack based on the user's data.

    :param user_data: Dictionary containing the user's information.
    :return: Predicted snack.
    """
    ...
    model_features = [
        ...
        'Assigned_Snack_Calories', 'Waist', 'Diabetes', 'Hypertension',
